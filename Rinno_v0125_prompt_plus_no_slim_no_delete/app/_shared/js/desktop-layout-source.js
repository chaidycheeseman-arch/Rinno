...
(function initFocusMode() {
    ...
    function showEditDialog(mode) {
        ...
        dlg.innerHTML = `
            ...
            <div class="focus-add-dialog-btns">
                <button type="button" class="focus-btn-cancel" id="focus-edit-cancel">取消</button>
                <button type="button" class="focus-btn-confirm" id="focus-edit-save">保存</button>
            </div>
        `;
    ...
    addBtn.addEventListener('click', (e) => {
        ...
        addDialog.innerHTML = `
            ...
            <div class="focus-add-dialog-btns">
                <button type="button" class="focus-btn-cancel" id="focus-new-cancel">取消</button>
                <button type="button" class="focus-btn-confirm" id="focus-new-confirm">添加</button>
            </div>
        `;
