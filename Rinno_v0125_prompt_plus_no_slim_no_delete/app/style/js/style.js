...
function applyStyleTheme() {
    ...
    root.style.setProperty('--rinno-component-surface', `linear-gradient(180deg, rgba(${theme.glassTint}, ${theme.dark ? 0.92 : 0.985}), rgba(${theme.glassTint}, ${theme.dark ? 0.78 : 0.91}))`);
    root.style.setProperty('--rinno-component-surface-soft', `linear-gradient(180deg, rgba(${theme.glassTint}, ${theme.dark ? 0.78 : 0.94}), rgba(${theme.glassTint}, ${theme.dark ? 0.62 : 0.82}))`);
    root.style.setProperty('--rinno-component-surface-flat', `rgba(${theme.glassTint}, ${theme.dark ? 0.78 : 0.94})`);
    root.style.setProperty('--rinno-component-border', `1px solid rgba(${theme.shadow}, ${theme.dark ? 0.26 : 0.095})`);
    root.style.setProperty('--rinno-component-highlight', `1px solid rgba(${theme.glassTint}, ${theme.dark ? 0.20 : 0.86})`);
    root.style.setProperty('--rinno-component-shadow', `0 18px 44px rgba(${theme.shadow}, ${theme.dark ? 0.24 : 0.058})`);
    root.style.setProperty('--rinno-component-shadow-soft', `0 8px 24px rgba(${theme.shadow}, ${theme.dark ? 0.20 : 0.040})`);
    ...
    root.style.setProperty('--rinno-app-icon-surface', `linear-gradient(180deg, rgba(${theme.glassTint}, ${theme.dark ? 0.82 : 0.96}), rgba(${theme.glassTint}, ${theme.dark ? 0.62 : 0.76}))`);
    root.style.setProperty('--rinno-app-icon-border', `1px solid rgba(${theme.shadow}, ${theme.dark ? 0.25 : 0.10})`);
    root.style.setProperty('--rinno-app-icon-shadow', `0 12px 28px rgba(${theme.shadow}, ${theme.dark ? 0.20 : 0.052}), inset 0 1px 0 rgba(${theme.glassTint}, ${theme.dark ? 0.22 : 0.82})`);
    root.style.setProperty('--style-icon-surface', 'var(--rinno-app-icon-surface)');
    root.style.setProperty('--style-control-shadow', `0 18px 42px rgba(${theme.shadow}, ${theme.dark ? 0.18 : 0.050})`);
    ...
    root.style.setProperty('--style-app-top-bg', `rgba(${theme.glassTint}, ${theme.dark ? 0.26 : 0.82})`);
    root.style.setProperty('--style-card-bg', `linear-gradient(180deg, rgba(${theme.glassTint}, ${theme.dark ? 0.30 : 0.94}), rgba(${theme.glassTint}, ${theme.dark ? 0.16 : 0.78}))`);
    root.style.setProperty('--style-soft-card-bg', `linear-gradient(135deg, rgba(${accentSoftRgb}, ${theme.dark ? 0.16 : 0.46}), rgba(${theme.glassTint}, ${theme.dark ? 0.18 : 0.88}))`);
    ...
    root.style.setProperty('--style-line-color', `rgba(${accentStrongRgb}, ${theme.dark ? 0.26 : 0.16})`);
    root.style.setProperty('--style-faint-line-color', `rgba(${accentStrongRgb}, ${theme.dark ? 0.16 : 0.09})`);
